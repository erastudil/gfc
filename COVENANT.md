...
This repo is a gift line. Same covenant as EasyLM, progen, and zcabs.

- official copy stays $0 forever
- donations only
- no company seat on this line
- writing in the standard is the user's
...
The standard is english prose order. Writing that way does not make a derivative work.

The files in this repository are the Program. Genome prompts, the markdown specification, the linter, the echo detector, the stripper, and the conformance fixtures are covered works.

If you load `prompts/genome.md` or `skills/gfc/SKILL.md` into a network service, you have modified and conveyed a covered work. Offer the corresponding source to the users of that service.
